...
/*    pub fn add_alias(&self, address: &H160, pubkey: &Pubkey) {
    ...
    pub fn apply<A, I, L>(&mut self, values: A, logs: L, delete_empty: bool, skip_addr: Option<(H160, bool, u64)>) -> Result<(), ProgramError>
            where
                A: IntoIterator<Item=Apply<I>>,
                I: IntoIterator<Item=(H256, H256)>,
                L: IntoIterator<Item=Log>,
    {        
        let ether_addr = skip_addr.unwrap_or_else(|| (H160::zero(), true, 0));
