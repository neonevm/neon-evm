...
use parity_crypto::publickey::{self, public_to_address, recover, Public, Signature};
/*
use crate::{
    hash::keccak,
    transaction::error,
...
pub fn keccak(data: &[u8]) -> H256 {
    use evm_loader::solana_program::keccak::hash;
...
impl UnverifiedTransaction {
    ...
    */
    ...
    pub fn recover_public(&self) -> Result<Public, publickey::Error> {
        ...
        // TODO: remove it
        let hash_ethereum_types =  unsafe{ mem::transmute::<ethereum_types::H256, primitive_types_0_10_1::H256>(hash_ethereum_types)};
