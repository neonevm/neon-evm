...
from solana_utils import sha256, solana_client, confirm_transaction, get_solana_balance,\
...
def create_account(seed: str):
    ...
    confirm_transaction(solana_client, trx['result'])
    return new_acc
...
class TestFundReturn:
    ...
    def test_creator_not_signer(self):
        ...
        with pytest.raises(SolanaRpcException, match=err_msg):
